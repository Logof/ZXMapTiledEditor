...
public class MapEditor implements ActionListener, MouseListener,
    ...
    private JCheckBoxMenuItem gridZXScreenMenuItem;
    private JCheckBoxMenuItem coordinatesMenuItem;
    private JCheckBoxMenuItem coordinatesZXScreenMenuItem;
    ...
    public MapEditor() {
        ...
        */
        ...
        try {
            ...
            log.info("Error while loading custom cursors!");
            e.printStackTrace();
        }
        */
        ...
        display.addPreferenceChangeListener(new PreferenceChangeListener() {
            public void preferenceChange(PreferenceChangeEvent event) {
                ...
                } else if ("showZXScreenGrid".equals(key)) {
                    mapView.setShowZXScreenGrid(display.getBoolean("showZXScreenGrid", false));
                }
            }
        });
    }
    ...
    private JPanel createContentPane() {
        ...
        tilesetsPanel = new FloatablePanel(getAppFrame(), tabbedTilesetsPane, PANEL_TILE_PALETTE, "tilesets");
        paletteSplit = new SmartSplitPane(JSplitPane.VERTICAL_SPLIT, true, mainSplit, tilesetsPanel.getContentPane(), "paletteSplit");
        paletteSplit.setOneTouchExpandable(true);
        paletteSplit.setResizeWeight(0.77);
        paletteSplit.setBorder(null);
    ...
    private void createMenuBar() {
        ...
        */
        ...
        gridZXScreenMenuItem = new JCheckBoxMenuItem(Resources.getString("menu.view.ZXScreen"));
        gridZXScreenMenuItem.addActionListener(this);
        gridZXScreenMenuItem.setToolTipText(Resources.getString("menu.view.ZXScreen.tooltip"));
        gridZXScreenMenuItem.setAccelerator(KeyStroke.getKeyStroke("shift Z"));
        ...
        coordinatesZXScreenMenuItem = new JCheckBoxMenuItem(Resources.getString("menu.view.ZXScreenCoordinates"));
        coordinatesZXScreenMenuItem.addActionListener(this);
        coordinatesZXScreenMenuItem.setToolTipText(Resources.getString("menu.view.ZXScreenCoordinates.tooltip"));
        ...
        viewMenu.add(coordinatesZXScreenMenuItem);
    ...
    public void setCurrentMap(Map newMap) {
        ...
        if (!mapLoaded) {
            ...
            mapView.setAntialiasGrid(display.getBoolean("gridAntialias", true));
            mapView.setGridColor(new Color(display.getInt("gridColor", MapView.DEFAULT_GRID_COLOR.getRGB())));
            mapView.setZXScreenGridColor(new Color(display.getInt("gridZXScreenColor", MapView.DEFAULT_ZX_SCREEN_GRID_COLOR.getRGB())));
            mapView.setShowGrid(display.getBoolean("showGrid", false));
            mapView.setShowZXScreenGrid(display.getBoolean("showZXScreenGrid", false));
            ...
            gridMenuItem.setState(mapView.getShowZXScreenGrid());

            coordinatesMenuItem.setState(mapView.getMode(MapView.PF_COORDINATES));
            coordinatesZXScreenMenuItem.setState(mapView.getMode(MapView.PF_ZX_SCREEN_COORDINATES));

            tileCoordsLabel.setText((currentMap.getWidth() - 1) + ", " + (currentMap.getHeight() - 1));
            tileCoordsLabel.setPreferredSize(null);
    ...
    private void handleEvent(ActionEvent event) {
        ...
        }  else if (command.equals(Resources.getString("menu.view.ZXScreen"))) {
            // Toggle grid
            Preferences displayPrefs = prefs.node("display");
            boolean showZXScreenGrid = displayPrefs.getBoolean("showZXScreenGrid", false);
            displayPrefs.putBoolean("showZXScreenGrid", !showZXScreenGrid);
        } else if (command.equals(Resources.getString("menu.view.coordinates"))) {
            // Toggle coordinates
            mapView.toggleMode(MapView.PF_COORDINATES);
        } else if (command.equals(Resources.getString("menu.view.ZXScreenCoordinates"))) {
            // Toggle coordinates
            mapView.toggleMode(MapView.PF_ZX_SCREEN_COORDINATES);
